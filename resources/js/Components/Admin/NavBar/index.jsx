        ...
        <Fragment>
            <nav id="header" className="z-2 top-10 py-1 bg-white shadow md:ml-64 border-b dark:bg-gray-900 dark:border-gray-700">
                <div className="w-full flex items-center justify-between mt-0 px-2 py-0">
                    <Overlay sHidenShow={showDropDownUser} closeDropdown={() => setShowDropDownUser(!showDropDownUser)} />
                    <Overlay sHidenShow={showDropDownNotifi} closeDropdown={() => setShowDropDownNotifi(!showDropDownNotifi)} />
                    <div></div>
                    ...
                    <div className="order-2 md:order-3 flex flex-wrap items-center justify-end mr-0 md:mr-4" id="nav-content">
                        <div className="auth flex items-center w-full md:w-full">
                            ...
                            <div className="px-4">
                                ...
                                <div className={`${showDropDownUser ? 'block' : 'hidden'} absolute right-1 z-2 w-64 py-2 mt-2 overflow-hidden bg-white rounded-md shadow-xl dark:bg-gray-900`}>
                                    ...
                                    <Link
                                        ...
                                        <img
                                            ...
                                            src={`/uploads/${auth.user.avatar ? auth.user.avatar : 'avatar.png'}`}
                                            alt={auth.user.name}
                                        />
                                        <div className="mx-1">
                                    ...
                                    <div className="block px-4 py-3 text-sm text-gray-600 font-medium transition-colors duration-200 transform dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 dark:hover:text-white">
                                        <Link
                                            as="button"
                                            type='button'
                                            href={route('logout')}
