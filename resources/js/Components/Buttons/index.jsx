...
import { IoCreateOutline, IoTrashOutline, IoSaveOutline } from 'react-icons/io5';
    ...
    return (
        <Fragment>
            ...
            >
                ...
                <div className="text-md ml-2 text-gray-50 hover:text-white">Salvar</div>
            </button>
                        ...
                        <div className="">
                            ...
                            <div className="text-center p-2 flex-auto justify-center">
                                ...
                                <div className="flex flex-col items-center justify-center">
                                    <IconContext.Provider value={{ className: "text-lg text-red-500 text-white" }}>
                                        <HiOutlineInformationCircle />
                                    </IconContext.Provider>
                                    <IconContext.Provider value={{ className: "text-7xl text-red-500 text-white" }}>
                                        <HiTrash />
                                    </IconContext.Provider>
                                </div>
